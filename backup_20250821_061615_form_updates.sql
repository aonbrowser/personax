...
F2_BIG5_01	Form2_Kisilik	Mizac	Openness	Yeni fikirlere ve deneyimlere açığımdır	Likert5		0	\N	1	\N	1	BIG_FIVE	I am open to new ideas and experiences	\N
F2_BIG5_02	Form2_Kisilik	Mizac	Conscientiousness	Detaylara dikkat eder planlı ve organize biriyimdir	Likert5		0	\N	1	\N	2	BIG_FIVE	I pay attention to details and am organized	\N
F2_BIG5_03	Form2_Kisilik	Mizac	Extraversion	Sosyal ortamlarda enerjik ve konuşkanımdır	Likert5		0	\N	1	\N	3	BIG_FIVE	I am energetic and talkative in social settings	\N
F2_BIG5_04	Form2_Kisilik	Mizac	Agreeableness	Genellikle başkalarının duygularına karşı duyarlı ve yardımseverimdir	Likert5		0	\N	1	\N	4	BIG_FIVE	I am generally sensitive and helpful to others' feelings	\N
F2_BIG5_05	Form2_Kisilik	Mizac	Neuroticism	Kolayca endişelenir veya strese girerim	Likert5		0	\N	1	\N	5	BIG_FIVE	I easily worry or get stressed	\N
F2_MBTI_06	Form2_Kisilik	BiliselTercih	S-N	Yeni bir şey öğrenirken hangisini tercih edersiniz?	SingleChoice	A) Somut gerçeklere pratik uygulamalara ve adım adım ilerleyen net talimatlara odaklanmayı|B) Teorik altyapıya büyük resme ve fikirler arasındaki bağlantıları anlamaya odaklanmayı	0	\N	1	\N	16	MBTI	When learning something new which do you prefer?	A) Focusing on concrete facts practical applications and clear step-by-step instructions|B) Focusing on theoretical background big picture and understanding connections between ideas
F2_MBTI_07	Form2_Kisilik	BiliselTercih	S-N	Bir olayı birine anlatırken...	SingleChoice	A) Olayın spesifik detaylarını kimin ne dediğini ve ne olduğunu olduğu gibi aktarmaya eğilimliyimdir|B) Olayın bende bıraktığı izlenimi anlamını ve altında yatan dinamikleri anlatmaya eğilimliyimdir	0	\N	1	\N	17	MBTI	When telling someone about an event...	A) I tend to convey specific details who said what and what happened as is|B) I tend to tell the impression meaning and underlying dynamics
F2_MBTI_08	Form2_Kisilik	BiliselTercih	S-N	Problem çözerken yaklaşımınız nedir?	SingleChoice	A) Mevcut ve kanıtlanmış yöntemleri kullanarak gerçekçi ve uygulanabilir çözümler bulurum|B) Olasılıkları ve yeni olasılıkları düşünerek yenilikçi ve alışılmadık çözümler ararım	0	\N	1	\N	18	MBTI	What is your problem-solving approach?	A) I find realistic and applicable solutions using existing proven methods|B) I look for innovative and unusual solutions by thinking about possibilities
F2_MBTI_09	Form2_Kisilik	BiliselTercih	S-N	Hangisi size daha çok hitap eder?	SingleChoice	A) Ayrıntılarda ustalık gizlidir|B) Hayal gücü bilgiden daha önemlidir	0	\N	1	\N	19	MBTI	Which appeals to you more?	A) Mastery lies in the details|B) Imagination is more important than knowledge
F2_MBTI_10	Form2_Kisilik	BiliselTercih	S-N	Genel olarak daha çok dikkat ettiğiniz şey...	SingleChoice	A) Gördüğüm duyduğum dokunduğum somut gerçeklerdir|B) Sezgilerim içgüdülerim ve olayların gelecekte nereye varabileceğine dair olasılıklardır	0	\N	1	\N	20	MBTI	What you generally pay more attention to...	A) Concrete facts I see hear and touch|B) My intuitions instincts and possibilities of where events might lead
F2_MBTI_11	Form2_Kisilik	BiliselTercih	T-F	Önemli bir karar verirken ağır basan taraf nedir?	SingleChoice	A) Mantıksal analiz objektif kriterler ve tutarlılık|B) Kararın insanları nasıl etkileyeceği kişisel değerlerim ve genel uyum	0	\N	1	\N	21	MBTI	What weighs more when making an important decision?	A) Logical analysis objective criteria and consistency|B) How the decision will affect people my personal values and overall harmony
F2_BIG5_06	Form2_Kisilik	Mizac	Openness	Geleneksel ve alışılmış yöntemleri tercih ederim	Likert5		1	\N	1	\N	6	BIG_FIVE	I prefer traditional and conventional methods	\N
F2_BIG5_07	Form2_Kisilik	Mizac	Conscientiousness	İşlerimi sık sık erteler dağınık çalışırım	Likert5		1	\N	1	\N	7	BIG_FIVE	I often procrastinate and work in a disorganized manner	\N
F2_BIG5_08	Form2_Kisilik	Mizac	Extraversion	Kalabalık sosyal ortamlardan sonra kendimi tükenmiş hissederim	Likert5		1	\N	1	\N	8	BIG_FIVE	I feel exhausted after crowded social settings	\N
F2_BIG5_09	Form2_Kisilik	Mizac	Agreeableness	Kendi çıkarlarımı başkalarınınkinden önde tutmaya eğilimliyimdir	Likert5		1	\N	1	\N	9	BIG_FIVE	I tend to prioritize my own interests over others	\N
F2_BIG5_10	Form2_Kisilik	Mizac	Neuroticism	Genellikle sakin ve duygusal olarak dengeliyimdir	Likert5		1	\N	1	\N	10	BIG_FIVE	I am generally calm and emotionally balanced	\N
F2_MBTI_12	Form2_Kisilik	BiliselTercih	T-F	Bir arkadaşınız derdini anlattığında ilk tepkiniz ne olur?	SingleChoice	A) Sorunu analiz edip mantıklı çözüm yolları sunmaya çalışmak|B) Onu anladığımı hissettirip duygusal destek ve teselli vermek	0	\N	1	\N	22	MBTI	Your first reaction when a friend tells their troubles?	A) Trying to analyze the problem and offer logical solutions|B) Making them feel understood and giving emotional support and comfort
F2_MBTI_13	Form2_Kisilik	BiliselTercih	T-F	Size söylense hangisi daha büyük bir iltifat olurdu?	SingleChoice	A) Sen çok mantıklı ve adil bir insansın|B) Sen çok şefkatli ve anlayışlı bir insansın	0	\N	1	\N	23	MBTI	Which would be a bigger compliment if said to you?	A) You are a very logical and fair person|B) You are a very compassionate and understanding person
F2_MBTI_14	Form2_Kisilik	BiliselTercih	T-F	Bir eleştiri yapmanız gerektiğinde...	SingleChoice	A) Doğru ve dürüst olmak adına gerçeği olduğu gibi söylemeyi tercih ederim|B) Karşımdakini kırmamak için sözlerimi dikkatle seçer ve daha diplomatik bir dil kullanırım	0	\N	1	\N	24	MBTI	When you need to give criticism...	A) I prefer to tell the truth as it is for the sake of being correct and honest|B) I choose my words carefully and use more diplomatic language to not hurt others
F2_MBTI_15	Form2_Kisilik	BiliselTercih	T-F	Bir grubun iyiliği için bir karar alınması gerektiğinde...	SingleChoice	A) En doğru ve etkili sonucun ne olduğuna odaklanırım bazı kişiler bundan hoşnut olmasa bile|B) Gruptaki herkesin kendini duyulmuş ve değerli hissetmesini sağlamaya uyumu korumaya odaklanırım	0	\N	1	\N	25	MBTI	When a decision needs to be made for the good of a group...	A) I focus on the most correct and effective outcome even if some people are not happy|B) I focus on making everyone feel heard and valued maintaining harmony
F2_MBTI_16	Form2_Kisilik	BiliselTercih	J-P	Hafta sonu planlarınız genellikle nasıldır?	SingleChoice	A) Genellikle ne yapacağıma önceden karar veririm ve bir plana sadık kalmayı severim|B) Plan yapmaktan kaçınır o an canım ne isterse onu yapmayı ve spontane olmayı tercih ederim	0	\N	1	\N	26	MBTI	What are your weekend plans usually like?	A) I usually decide beforehand and like to stick to a plan|B) I avoid making plans preferring to be spontaneous
F2_MBTI_17	Form2_Kisilik	BiliselTercih	J-P	Bir işi yaparken kendinizi nasıl daha iyi hissedersiniz?	SingleChoice	A) İşi tamamlayıp listemden bir maddeyi daha çizdiğimde|B) Henüz seçenekler açıkken ve işin gidişatını değiştirebilecek esnekliğe sahipken	0	\N	1	\N	27	MBTI	How do you feel better when doing a job?	A) When I complete the job and cross another item off my list|B) When options are still open and I have flexibility to change the course
F2_VALUES	Form2_Kisilik	Motivasyon		Bu değerleri sizin için en önemliden en az önemliye doğru sıralayınız (1=en önemli 10=en az önemli)	Ranking	Başarı|Güç|Heyecan|Özyönelim|İyilikseverlik|Evrenselcilik|Güvenlik|Gelenek|Uyum|Hazcılık	0	\N	1	\N	31	VALUES	Rank these values from most to least important to you (1=most 10=least)	Achievement|Power|Excitement|Self-direction|Benevolence|Universalism|Security|Tradition|Conformity|Hedonism
F3_BELIEF_01	Form3_Davranis	DerinInanclar	Internal	Hayatımda başıma gelenlerin kontrolü büyük ölçüde bendedir	Likert5		0	\N	1	\N	21	LOCUS_OF_CONTROL	I have control over most things that happen in my life	\N
F3_BELIEF_02	Form3_Davranis	DerinInanclar	Failure	Ne kadar çabalarsam çabalayayım sonunda başarısız olacağımı hissederim	Likert5		0	\N	1	\N	22	SCHEMA	No matter how hard I try I feel I will ultimately fail	\N
F3_BELIEF_03	Form3_Davranis	DerinInanclar	Defectiveness	Derinlerde bir yerde kusurlu ve sevilmeye layık olmadığıma inanırım	Likert5		0	\N	1	\N	23	SCHEMA	Deep down I believe I am flawed and unworthy of love	\N
F3_BELIEF_04	Form3_Davranis	DerinInanclar	External	Hayatta başıma gelen iyi şeylerin çoğu şans eseridir	Likert5		0	\N	1	\N	24	LOCUS_OF_CONTROL	Most good things that happen to me are due to luck	\N
F3_BELIEF_05	Form3_Davranis	DerinInanclar	Abandonment	İnsanların eninde sonunda beni hayal kırıklığına uğratacağına veya terk edeceğine inanırım	Likert5		0	\N	1	\N	25	SCHEMA	I believe people will eventually disappoint or abandon me	\N
F3_BELIEF_06	Form3_Davranis	DerinInanclar	Subjugation	Kendi ihtiyaçlarımı ifade edersem başkalarını kaybedeceğimden veya cezalandırılacağımdan korkarım	Likert5		0	\N	1	\N	26	SCHEMA	I fear losing others or being punished if I express my needs	\N
F3_ATTACH_01	Form3_Davranis	IliskiSablonlari	Anxiety	Partnerimin beni terk edeceğinden sık sık endişe duyarım	Likert5		0	\N	1	\N	27	ATTACHMENT	I often worry that my partner will leave me	\N
F3_ATTACH_03	Form3_Davranis	IliskiSablonlari	Anxiety	Partnerimin bana değer verdiği kadar benim ona değer vermediğimden korkarım	Likert5		0	\N	1	\N	29	ATTACHMENT	I fear my partner doesn't value me as much as I value them	\N
F3_ATTACH_02	Form3_Davranis	IliskiSablonlari	Avoidance	Başkalarına duygusal olarak çok yakınlaşmaktan rahatsız olurum	Likert5		0	\N	1	\N	28	ATTACHMENT	I feel uncomfortable getting emotionally close to others	\N
F3_ATTACH_04	Form3_Davranis	IliskiSablonlari	Avoidance	Bağımsızlığımı ve kendi kendime yetmeyi her şeyden önemli görürüm	Likert5		0	\N	1	\N	30	ATTACHMENT	I value my independence and self-sufficiency above everything	\N
F3_STORY_01	Form3_Davranis	YasamAnlatisi		Hayatınızda kendinizi gerçekten canlı özgür ve tam anlamıyla kendiniz gibi hissettiğiniz bir anı veya dönemi anlatır mısınız? Bu anı bu kadar özel kılan neydi?	OpenText		0	\N	1	\N	33	NARRATIVE	Describe a moment when you felt truly alive free and completely yourself	\N
F3_STORY_02	Form3_Davranis	YasamAnlatisi		Başkalarının sizde en çok takdir ettiğini söylediği veya kendinizle sessizce gurur duymanızı sağlayan üç temel özelliğiniz nedir?	OpenText		0	\N	1	\N	34	NARRATIVE	What three core qualities do others appreciate most in you or make you quietly proud?	\N
F3_STORY_03	Form3_Davranis	YasamAnlatisi		Eğer sihirli bir değneğiniz olsaydı kendinizde değiştirmek veya geliştirmek isteyeceğiniz üç şey ne olurdu?	OpenText		0	\N	1	\N	35	NARRATIVE	If you had a magic wand what three things would you change or improve about yourself?	\N
F3_STORY_04	Form3_Davranis	YasamAnlatisi		Hayatınızdaki en mutlu anlarınızı (en çok üç adet) anlatır mısınız? O anı bu kadar özel ve neşeli kılan neydi?	OpenText		0	\N	1	\N	36	NARRATIVE	Describe your happiest moments (up to three). What made them so special and joyful?	\N
F3_STORY_05	Form3_Davranis	YasamAnlatisi		Geçmişe baktığınızda hatırladığınız en kötü anılar neler (en çok üç adet)?	OpenText		0	\N	1	\N	37	NARRATIVE	What are your worst memories from the past (up to three)?	\N
F3_STORY_06	Form3_Davranis	YasamAnlatisi		Geriye dönüp baktığınızda önemli bir pişmanlığınızı anlatın. Geri dönebilseydiniz neyi farklı yapardınız ve bu deneyimden ne öğrendiniz?	OpenText		0	\N	1	\N	38	NARRATIVE	Describe an important regret. What would you do differently and what did you learn?	\N
F3_STORY_07	Form3_Davranis	YasamAnlatisi		En çok gurur duyduğunuz bir başarıyı veya kararı anlatın. Bu an en iyi halinizdeyken kim olduğunuz hakkında ne söylüyor?	OpenText		0	\N	1	\N	39	NARRATIVE	Describe an achievement or decision you're most proud of. What does it say about who you are at your best?	\N
F3_STORY_08	Form3_Davranis	YasamAnlatisi		Hayatınızın bir sonraki bölümünü düşünürken en büyük umudunuz nedir? Ve en büyük korkunuz nedir?	OpenText		0	\N	1	\N	40	NARRATIVE	When thinking about the next chapter of your life what is your greatest hope? And your greatest fear?	\N
F3_ATTACH_05	Form3_Davranis	IliskiSablonlari	Anxiety	Partnerimden istediğim kadar yakınlık ve ilgi göremediğimde hayal kırıklığına uğrarım	Likert5		0	\N	1	\N	31	ATTACHMENT	I get disappointed when I don't receive the closeness and attention I want from my partner	\N
F3_ATTACH_06	Form3_Davranis	IliskiSablonlari	Avoidance	Başkalarına güvenmekte ve onlara bel bağlamakta zorlanırım	Likert5		0	\N	1	\N	32	ATTACHMENT	I have difficulty trusting and relying on others	\N
F2_MBTI_01	Form2_Kisilik	BiliselTercih	E-I	Yoğun bir haftanın ardından kendinizi nasıl şarj edersiniz?	SingleChoice	A) Arkadaşlarımla buluşarak veya sosyal bir etkinliğe katılarak enerji toplarım|B) Yalnız kalarak kitap okuyarak veya sessiz bir ortamda düşünerek enerji toplarım	0	\N	1	\N	11	MBTI	How do you recharge after an intense week?	A) I gain energy by meeting with friends or attending social events|B) I gain energy by being alone reading or thinking in a quiet environment
F2_MBTI_02	Form2_Kisilik	BiliselTercih	E-I	Bir sosyal etkinlikte veya partide genellikle...	SingleChoice	A) Birçok farklı insanla sohbet eder ortamın merkezinde yer alırım|B) Bir veya iki kişiyle derin ve anlamlı bir sohbet kurmayı tercih ederim	0	\N	1	\N	12	MBTI	At a social event or party you usually...	A) Chat with many different people and be at the center|B) Prefer deep and meaningful conversations with one or two people
F2_MBTI_03	Form2_Kisilik	BiliselTercih	E-I	Bir proje üzerinde çalışırken...	SingleChoice	A) Fikirlerimi bir grupla tartışarak ve beyin fırtınası yaparak geliştirmeyi severim|B) Önce kendi başıma düşünüp fikirlerimi netleştirmeyi tercih ederim	0	\N	1	\N	13	MBTI	When working on a project...	A) I like developing ideas by discussing and brainstorming with a group|B) I prefer thinking on my own first and clarifying my ideas
F2_MBTI_04	Form2_Kisilik	BiliselTercih	E-I	İlgi odağı olmak sizi nasıl hissettirir?	SingleChoice	A) Genellikle rahatsız olmam hatta bazen bundan keyif alabilirim|B) Beni gergin ve rahatsız hissettirir genellikle bundan kaçınırım	0	\N	1	\N	14	MBTI	How does being the center of attention make you feel?	A) I usually don't feel uncomfortable sometimes even enjoy it|B) It makes me feel tense and uncomfortable I usually avoid it
F2_MBTI_05	Form2_Kisilik	BiliselTercih	E-I	Yeni tanıştığınız insanlara karşı tavrınız nasıldır?	SingleChoice	A) Genellikle konuşmayı ben başlatırım ve kendim hakkında kolayca bilgi paylaşırım|B) Genellikle karşımdakinin soru sormasını bekler daha çok dinleyici konumunda kalırım	0	\N	1	\N	15	MBTI	Your attitude towards people you just met?	A) I usually start the conversation and easily share information about myself|B) I usually wait for others to ask questions and remain more in listener position
F2_MBTI_18	Form2_Kisilik	BiliselTercih	J-P	Sizi daha iyi tanımlayan kelime hangisi?	SingleChoice	A) Düzenli|B) Esnek	0	\N	1	\N	28	MBTI	Which word describes you better?	A) Organized|B) Flexible
F2_MBTI_19	Form2_Kisilik	BiliselTercih	J-P	Son teslim tarihleri (deadline) hakkında ne düşünürsünüz?	SingleChoice	A) İşleri zamanında bitirmemi sağlayan faydalı ve motive edici araçlardır|B) Yaratıcılığı ve esnekliği kısıtlayan gereksiz birer stres kaynağıdır	0	\N	1	\N	29	MBTI	What do you think about deadlines?	A) They are useful and motivating tools that help me finish work on time|B) They are unnecessary sources of stress that restrict creativity and flexibility
F2_MBTI_20	Form2_Kisilik	BiliselTercih	J-P	Bir seyahate çıkarken...	SingleChoice	A) Gideceğim yerleri kalacağım oteli ve yapacağım aktiviteleri önceden planlamayı ve organize etmeyi severim|B) Sadece genel bir rota belirler geri kalan detayları yolculuk sırasında akışına bırakırım	0	\N	1	\N	30	MBTI	When going on a trip...	A) I like to plan and organize places hotel and activities in advance|B) I just set a general route leaving details to flow during the journey
F1_AGE	Form1_Tanisalim	Demografik		Yaşınız	Number		0	\N	1	\N	1	DEMOGRAPHIC	Your age	\N
F1_GENDER	Form1_Tanisalim	Demografik		Cinsiyetiniz	SingleChoice	Erkek|Kadın|Belirtmek İstemiyorum|Diğer	0	\N	1	\N	2	DEMOGRAPHIC	Your gender	Male|Female|Prefer not to say|Other
F1_RELATIONSHIP	Form1_Tanisalim	Demografik		İlişki Durumunuz	SingleChoice	Bekâr|İlişkisi var|Evli|Boşanmış|Diğer	0	\N	1	\N	3	DEMOGRAPHIC	Relationship status	Single|In a relationship|Married|Divorced|Other
F1_EDUCATION	Form1_Tanisalim	Demografik		En Yüksek Eğitim Seviyeniz	SingleChoice	İlköğretim|Lise|Üniversite|Yüksek Lisans|Doktora	0	\N	1	\N	4	DEMOGRAPHIC	Highest education level	Primary|High School|University|Master's|PhD
F1_OCCUPATION	Form1_Tanisalim	Demografik		Mesleğiniz / Çalışma Durumunuz	OpenText		0	\N	1	\N	5	DEMOGRAPHIC	Your occupation/work status	\N
F1_FOCUS_AREAS	Form1_Tanisalim	HayataBakis		Şu anda hayatınızdaki temel odak alanlarınız hangileri? (En fazla 3 tane seçin)	MultiSelect3	Kariyer/İş|Aile|Romantik İlişki|Arkadaşlar/Sosyal Hayat|Kişisel Gelişim|Fiziksel Sağlık|Ruhsal Sağlık|Finansal Durum|Hobiler	0	\N	1	\N	8	DEMOGRAPHIC	What are your main focus areas in life right now? (Select up to 3)	Career/Work|Family|Romantic Relationship|Friends/Social Life|Personal Development|Physical Health|Mental Health|Financial Status|Hobbies
F1_LIFE_SATISFACTION	Form1_Tanisalim	HayataBakis		Genel olarak hayatınızdan ne kadar memnunsunuz? (1: Hiç memnun değilim - 10: Son derece memnunum)	Scale10		0	\N	1	\N	6	SITUATIONAL	How satisfied are you with your life in general? (1-10)	\N
F1_STRESS_LEVEL	Form1_Tanisalim	HayataBakis		Şu anki stres seviyenizi nasıl tanımlarsınız? (1: Neredeyse hiç stres yok - 10: Aşırı stresli)	Scale10		0	\N	1	\N	7	SITUATIONAL	How would you describe your current stress level? (1-10)	\N
F3_DISC_08_LEAST	Form3_Davranis	DavranisStili	\N	Size EN AZ uyan kelimeyi seçin	SingleChoice	Hırslı|Sosyal|İstikrarlı|Analitik	0	\N	1	\N	16	DISC	Select the word that describes you LEAST	Ambitious|Social|Stable|Analytical
F3_DISC_09_MOST	Form3_Davranis	DavranisStili	\N	Size EN ÇOK uyan kelimeyi seçin	SingleChoice	Direkt|Konuşkan|Destekleyici|Dikkatli	0	\N	1	\N	17	DISC	Select the word that describes you MOST	Direct|Talkative|Supportive|Careful
F3_DISC_09_LEAST	Form3_Davranis	DavranisStili	\N	Size EN AZ uyan kelimeyi seçin	SingleChoice	Direkt|Konuşkan|Destekleyici|Dikkatli	0	\N	1	\N	18	DISC	Select the word that describes you LEAST	Direct|Talkative|Supportive|Careful
F3_DISC_10_MOST	Form3_Davranis	DavranisStili	\N	Size EN ÇOK uyan kelimeyi seçin	SingleChoice	Güçlü|Eğlenceli|Nazik|Mantıklı	0	\N	1	\N	19	DISC	Select the word that describes you MOST	Strong|Fun|Kind|Logical
F3_DISC_10_LEAST	Form3_Davranis	DavranisStili	\N	Size EN AZ uyan kelimeyi seçin	SingleChoice	Güçlü|Eğlenceli|Nazik|Mantıklı	0	\N	1	\N	20	DISC	Select the word that describes you LEAST	Strong|Fun|Kind|Logical
F1_BIGGEST_CHALLENGE	Form1_Tanisalim	HayataBakis		Şu anda karşılaştığınız en büyük zorluk nedir?	OpenText		0	\N	1	\N	9	SITUATIONAL	What is the biggest challenge you're facing right now?	\N
F1_PHYSICAL_ACTIVITY	Form1_Tanisalim	EnerjiAliskanlik		Haftalık fiziksel aktivite seviyeniz nedir?	SingleChoice	Hareketsiz|Düşük (Haftada 1-2 gün hafif egzersiz)|Orta (Haftada 3-4 gün)|Yüksek (Haftada 5+ gün)	0	\N	1	\N	12	LIFESTYLE	What is your weekly physical activity level?	Sedentary|Low (1-2 days light exercise)|Medium (3-4 days)|High (5+ days)
F1_ENERGY_LEVEL	Form1_Tanisalim	EnerjiAliskanlik		Gün içindeki genel enerji seviyenizi nasıl puanlarsınız? (1: Çok Düşük - 10: Çok Yüksek)	Scale10		0	\N	1	\N	13	LIFESTYLE	How would you rate your general energy level during the day? (1-10)	\N
F3_DISC_01_MOST	Form3_Davranis	DavranisStili	\N	Size EN ÇOK uyan kelimeyi seçin	SingleChoice	Maceracı|Cana yakın|Uyumlu|Kültürlü	0	\N	1	\N	1	DISC	Select the word that describes you MOST	Adventurous|Friendly|Harmonious|Cultured
F3_DISC_01_LEAST	Form3_Davranis	DavranisStili	\N	Size EN AZ uyan kelimeyi seçin	SingleChoice	Maceracı|Cana yakın|Uyumlu|Kültürlü	0	\N	1	\N	2	DISC	Select the word that describes you LEAST	Adventurous|Friendly|Harmonious|Cultured
F3_DISC_02_MOST	Form3_Davranis	DavranisStili	\N	Size EN ÇOK uyan kelimeyi seçin	SingleChoice	Cesur|Neşeli|Güvenilir|Detaycı	0	\N	1	\N	3	DISC	Select the word that describes you MOST	Brave|Cheerful|Reliable|Detailed
F3_DISC_02_LEAST	Form3_Davranis	DavranisStili	\N	Size EN AZ uyan kelimeyi seçin	SingleChoice	Cesur|Neşeli|Güvenilir|Detaycı	0	\N	1	\N	4	DISC	Select the word that describes you LEAST	Brave|Cheerful|Reliable|Detailed
F1_YEARLY_GOAL	Form1_Tanisalim	HayataBakis		Önümüzdeki bir yıl içinde ulaşmak istediğiniz en önemli hedef nedir?	OpenText		0	\N	1	\N	10	LIFE_VIEW	What is your most important goal for the next year?	\N
F1_SLEEP_QUALITY	Form1_Tanisalim	EnerjiAliskanlik		Genel olarak uyku kalitenizi nasıl puanlarsınız? (1: Çok Kötü - 10: Mükemmel)	Scale10		0	\N	1	\N	11	ENERGY_HABITS	How would you rate your sleep quality? (1-10)	\N
F3_DISC_03_MOST	Form3_Davranis	DavranisStili	\N	Size EN ÇOK uyan kelimeyi seçin	SingleChoice	Sonuç odaklı|İkna edici|Barışçıl|Mükemmeliyetçi	0	\N	1	\N	5	DISC	Select the word that describes you MOST	Result-oriented|Persuasive|Peaceful|Perfectionist
F3_DISC_03_LEAST	Form3_Davranis	DavranisStili	\N	Size EN AZ uyan kelimeyi seçin	SingleChoice	Sonuç odaklı|İkna edici|Barışçıl|Mükemmeliyetçi	0	\N	1	\N	6	DISC	Select the word that describes you LEAST	Result-oriented|Persuasive|Peaceful|Perfectionist
F3_DISC_04_MOST	Form3_Davranis	DavranisStili	\N	Size EN ÇOK uyan kelimeyi seçin	SingleChoice	Otoriter|Popüler|Fedakâr|Hassas	0	\N	1	\N	7	DISC	Select the word that describes you MOST	Authoritative|Popular|Self-sacrificing|Sensitive
F3_DISC_04_LEAST	Form3_Davranis	DavranisStili	\N	Size EN AZ uyan kelimeyi seçin	SingleChoice	Otoriter|Popüler|Fedakâr|Hassas	0	\N	1	\N	8	DISC	Select the word that describes you LEAST	Authoritative|Popular|Self-sacrificing|Sensitive
F3_DISC_05_MOST	Form3_Davranis	DavranisStili	\N	Size EN ÇOK uyan kelimeyi seçin	SingleChoice	Rekabetçi|İlham veren|Tahammüllü|Tedbirli	0	\N	1	\N	9	DISC	Select the word that describes you MOST	Competitive|Inspiring|Tolerant|Cautious
F3_DISC_05_LEAST	Form3_Davranis	DavranisStili	\N	Size EN AZ uyan kelimeyi seçin	SingleChoice	Rekabetçi|İlham veren|Tahammüllü|Tedbirli	0	\N	1	\N	10	DISC	Select the word that describes you LEAST	Competitive|Inspiring|Tolerant|Cautious
F3_DISC_06_MOST	Form3_Davranis	DavranisStili	\N	Size EN ÇOK uyan kelimeyi seçin	SingleChoice	Kararlı|Hevesli|Sadık|Titiz	0	\N	1	\N	11	DISC	Select the word that describes you MOST	Determined|Enthusiastic|Loyal|Meticulous
F3_DISC_06_LEAST	Form3_Davranis	DavranisStili	\N	Size EN AZ uyan kelimeyi seçin	SingleChoice	Kararlı|Hevesli|Sadık|Titiz	0	\N	1	\N	12	DISC	Select the word that describes you LEAST	Determined|Enthusiastic|Loyal|Meticulous
F3_DISC_07_MOST	Form3_Davranis	DavranisStili	\N	Size EN ÇOK uyan kelimeyi seçin	SingleChoice	Talepkar|İyimser|Sabırlı|Kuralcı	0	\N	1	\N	13	DISC	Select the word that describes you MOST	Demanding|Optimistic|Patient|Rule-oriented
F3_DISC_07_LEAST	Form3_Davranis	DavranisStili	\N	Size EN AZ uyan kelimeyi seçin	SingleChoice	Talepkar|İyimser|Sabırlı|Kuralcı	0	\N	1	\N	14	DISC	Select the word that describes you LEAST	Demanding|Optimistic|Patient|Rule-oriented
F3_DISC_08_MOST	Form3_Davranis	DavranisStili	\N	Size EN ÇOK uyan kelimeyi seçin	SingleChoice	Hırslı|Sosyal|İstikrarlı|Analitik	0	\N	1	\N	15	DISC	Select the word that describes you MOST	Ambitious|Social|Stable|Analytical
\.
